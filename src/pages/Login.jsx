          ...
          <div className={styles.Form}>
            ...
            <div className={styles.Contrasena}>
              ...
              <button
                ...
                style={{ cursor: "pointer", color: "rgb(87, 86, 86)" }}
                onClick={() => {
                  submit.handleButtonClick(false);
                  setPopUp2(true);
                }}
              >
              ...
              <div className={styles.Type}>
                {toggle ? (
                  <p style={{ fontSize: "14px" }}>Administrador</p>
                ) : (
                  <p style={{ fontSize: "14px" }}>Estudiante </p>
                )}
                <div
                ...
                >
                  {toggle ? (
                    <div className={styles.ToggleRight}></div>
                  ) : (
                    <div className={styles.ToggleLeft}></div>
                  )}
                </div>
              </div>
            </div>
            <div className={styles.Buttons}>
              <button
                ...
                type="button"
                onClick={() => {
                  submit.handleButtonClick(true), handleLogin();
                }}
              >
                {" "}
                Iniciar Sesión{" "}
              ...
              <button
                ...
                style={{ cursor: "pointer" }}
                onClick={() => {
                  submit.handleButtonClick(false), navigate("/registro");
                }}
              >
